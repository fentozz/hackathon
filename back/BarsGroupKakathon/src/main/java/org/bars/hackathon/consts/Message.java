...
public enum Message {
    ...
    UPLOAD_SUCCESS("Файл был успешно загружен", 754),
    UPLOAD_FAILED_BY_OVERLOAD("Превышен максимальный размер допустимого пространства", 755),
    UPLOAD_FAILED_BY_UNDEFINED_EXTENSION("Не удалось определить расширение файла", 756);
